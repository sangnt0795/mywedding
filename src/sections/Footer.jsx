...
const Footer = ({ data }) => {
  return (
    <SectionReveal as="footer" className="px-5 pb-10 pt-6 text-center sm:px-8">
      <div className="mx-auto max-w-3xl rounded-[2.4rem] border border-champagne/80 bg-white/70 px-6 py-9 shadow-card">
