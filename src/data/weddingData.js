export const weddingData = {
  ...
  family: {
    ...
    bride: 'Gia đình nhà gái',
  },

  dialogue: [
    'Hi~ bạn thân mến~',
    'Khi bạn đọc những dòng này',
    'Ngày cưới của chúng mình',
    'đang đến rất gần 💕',
    'Đây là tấm thiệp cưới',
    'chứa đầy yêu thương và mong đợi 💌',
    'Muốn kể với bạn về “chúng mình”',
  ],
  ...
  schedule: [
    {
      label: 'Làm lễ',
      time: '11:00',
      note: 'Đón khách và cử hành hôn lễ',
    },
    {
      label: 'Tiệc cưới',
      time: '12:00',
      note: 'Dùng tiệc thân mật cùng gia đình',
    },
  ],
